...
# CI runs this in the splunk-ta-appinspect job; locally, install
# splunk-appinspect first.
test-bdd-splunk-appinspect:
	BDD_TAGS=@appinspect go test -race -v -count=1 -tags=integration ./tests/bdd/...
