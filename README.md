...
|----------|-------------|
| 📖 [Progressive Examples](examples/) | 17 examples from "hello world" to a [complete CRUD API](examples/16-crud-api/) — every output type, TLS policy, routing, formatters, and testing |
