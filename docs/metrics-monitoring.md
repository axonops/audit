...
([`examples/21-capstone/metrics.go`](../examples/21-capstone/metrics.go))
...
[examples/17-health-endpoint](../examples/17-health-endpoint/).
...
- [Progressive Example: Capstone](../examples/21-capstone/) — Prometheus metrics integration
