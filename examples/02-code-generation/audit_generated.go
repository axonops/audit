...
// UserDeleteFields describes every field on a EventUserDelete event.
...
// UserDeleteEvent builds a type-safe audit event.
...
// UserReadFields describes every field on a EventUserRead event.
type UserReadFields struct {
	Outcome audit.FieldInfo
	ActorID audit.FieldInfo
}

// UserReadEvent builds a type-safe audit event.
