...
> **Previous:** [10 — Multi-Output Fan-Out](../10-multi-output/) |
...
- Go 1.26+
- Completed: [Multi-Output](../10-multi-output/)
...
[Capstone](../21-capstone/) example shows every category using the struct
...
The [Capstone](../21-capstone/) example uses this: `auth_failure` is
