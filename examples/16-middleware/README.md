...
> **Previous:** [15 — Buffering](../15-buffering/) |
> **Next:** [17 — Health Endpoint](../17-health-endpoint/)
# Example 16: HTTP Middleware
...
| `EventType` | Override the event type (used by auth middleware — see [Capstone](../21-capstone/)) |
...
status code. The [Capstone](../21-capstone/) example shows this with auth
