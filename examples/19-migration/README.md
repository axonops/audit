...
> **Previous:** [18 — Testing](../18-testing/) |
> **Next:** [20 — Prometheus Reference](../20-prometheus-reference/)
...
- [Example 06 — HTTP Middleware](../16-middleware/) — middleware-based auditing for full request lifecycle
- [Example 17 — Capstone](../21-capstone/) — production-grade pattern with four outputs, HMAC, and Loki dashboards
