...
- **Outputs** → [06-syslog-output](06-syslog-output/),
  ...
  [08-loki-output](08-loki-output/),
  [09-splunk-output](09-splunk-output/). Each output type's setup,
  failure modes, and configuration.
- **Multi-output and production patterns** →
  [10-multi-output](10-multi-output/),
  [11-event-routing](11-event-routing/),
  [12-sensitivity-labels](12-sensitivity-labels/),
  [13-hmac-integrity](13-hmac-integrity/),
  [14-tls-policy](14-tls-policy/), [15-buffering](15-buffering/).
...
- **Integration and operational** →
  ...
  [17-health-endpoint](17-health-endpoint/),
  [18-testing](18-testing/). Automatic HTTP audit logging,
...
- **Adoption and reference** →
  ...
  [20-prometheus-reference](20-prometheus-reference/).
  `log/slog` coexistence pattern, drop-in Prometheus metrics
  adapter.
- **Capstone** → [21-capstone](21-capstone/). Complete inventory
...
| 9 | [splunk-output](09-splunk-output/) | Splunk HEC output with CIM Change formatter, indexer acknowledgement, and reference TA |
| 10 | [multi-output](10-multi-output/) | Fan-out to multiple outputs from one YAML config |
...
| 18 | [testing](18-testing/) | Testing audit events with audittest.New |
...
| 21 | [capstone](21-capstone/) | Complete inventory demo with web UI, Postgres, four outputs, Grafana, Prometheus |
