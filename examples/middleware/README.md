...
| `EventType` | Override the event type (used by auth middleware — see [CRUD API](../crud-api/)) |
...
status code. The [CRUD API](../crud-api/) example shows this with auth
...
[Formatters](../formatters/) — JSON vs CEF formatters configured in YAML.
