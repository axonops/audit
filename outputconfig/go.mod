...
require (
	...
	github.com/axonops/audit/secrets/env v0.2.4
	github.com/axonops/audit/secrets/file v0.2.4
	github.com/axonops/audit/secrets/openbao v0.2.4
	github.com/axonops/audit/secrets/vault v0.2.4
