...
var EventFields = map[string]struct {
	...
	EventAuthFailure: {
		...
		Optional: []string{FieldMarker},
	},
	EventUserCreate: {
		Required: []string{FieldActorID, FieldOutcome},
		Optional: []string{FieldMarker, FieldRetryAfter, FieldSessionCount},
	},
	EventUserUpdate: {
		Required: []string{FieldActorID, FieldOutcome},
		Optional: []string{FieldMarker},
...
type AuthFailureFields struct {
	...
	Marker     audit.FieldInfo // optional
...
// SetMarker sets the FieldMarker field.
func (e *AuthFailureEvent) SetMarker(v string) *AuthFailureEvent {
	e.fields[FieldMarker] = v
	return e
}
...
func (e *AuthFailureEvent) FieldInfo() AuthFailureFields {
	return AuthFailureFields{
		...
		Marker:     audit.FieldInfo{Name: FieldMarker},
...
type UserCreateFields struct {
	...
	Outcome      audit.FieldInfo // required
	Marker       audit.FieldInfo // optional
	RetryAfter   audit.FieldInfo // optional
	SessionCount audit.FieldInfo // optional
	Action       audit.FieldInfo // reserved standard
	ActorUID     audit.FieldInfo // reserved standard
	DestHost     audit.FieldInfo // reserved standard
	DestIP       audit.FieldInfo // reserved standard
...
// SetMarker sets the FieldMarker field.
func (e *UserCreateEvent) SetMarker(v string) *UserCreateEvent {
	e.fields[FieldMarker] = v
	return e
}

// SetRetryAfter sets the FieldRetryAfter field.
func (e *UserCreateEvent) SetRetryAfter(v time.Duration) *UserCreateEvent {
	e.fields[FieldRetryAfter] = v
	return e
}

// SetSessionCount sets the FieldSessionCount field.
func (e *UserCreateEvent) SetSessionCount(v int) *UserCreateEvent {
	e.fields[FieldSessionCount] = v
	return e
}
...
func (e *UserCreateEvent) FieldInfo() UserCreateFields {
	return UserCreateFields{
		...
		Outcome:      audit.FieldInfo{Name: FieldOutcome, Required: true},
		Marker:       audit.FieldInfo{Name: FieldMarker},
		RetryAfter:   audit.FieldInfo{Name: FieldRetryAfter},
		SessionCount: audit.FieldInfo{Name: FieldSessionCount},
		Action:       audit.FieldInfo{Name: FieldAction},
		ActorUID:     audit.FieldInfo{Name: FieldActorUID},
		DestHost:     audit.FieldInfo{Name: FieldDestHost},
		DestIP:       audit.FieldInfo{Name: FieldDestIP},
...
func (e *UserCreateEvent) FieldInfoMap() map[string]audit.FieldInfo {
	return map[string]audit.FieldInfo{
		...
		FieldOutcome:      {Name: FieldOutcome, Required: true},
		FieldMarker:       {Name: FieldMarker},
		FieldRetryAfter:   {Name: FieldRetryAfter},
		FieldSessionCount: {Name: FieldSessionCount},
		FieldAction:       {Name: FieldAction},
		FieldActorUID:     {Name: FieldActorUID},
		FieldDestHost:     {Name: FieldDestHost},
		FieldDestIP:       {Name: FieldDestIP},
...
// SetMarker sets the FieldMarker field.
func (e *UserUpdateEvent) SetMarker(v string) *UserUpdateEvent {
	e.fields[FieldMarker] = v
	return e
}
